...
Mount Rainier is an active volcano located in the central washington. There have been several reports of triggered seismicity caused by dynamic stress changes from surface waves resulting from large earthquake. Waveforms of one hour window since the origin of earthquake from all the stations lying within 100 Kms of Mount Rainier peak were downloaded, resulting in a combined 34 stations and all the three channels from 'UO','UW' and 'CC' networks. 10 of these stations were Broadband and the rest were short period stations. 
